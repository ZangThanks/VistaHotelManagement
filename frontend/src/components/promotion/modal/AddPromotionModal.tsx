        ...
        const submitData: Partial<Promotion> & {
            ...
            promotionType: formData.promotionType
                ? {
                      ...
                      promotionTYPEName:
                          formData.promotionType.promotionTYPEName || '',
                  }
                : undefined,
