...
const RoomFilters: React.FC<RoomFiltersProps> = ({
  ...
  return (
    <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-[#ebe3d7]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3 sm:gap-4">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="relative">
            <FaSearch className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 z-10 text-xs sm:text-sm" />
            <input
              type="text"
              placeholder="Search..."
      ...
      <div className="mt-3 sm:mt-4 flex justify-end">
        <button
          onClick={handleReset}
          className="px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors cursor-pointer"
        >
          Reset Filters
        </button>
      </div>
