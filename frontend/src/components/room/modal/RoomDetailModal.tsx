                        ...
                        >
                            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl max-h-[95vh] overflow-hidden flex flex-col">
                                ...
                                <div className="flex gap-3 p-6 border-t border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                                    ...
                                    <button className="flex-1 bg-[#6b5e4c] hover:bg-[#5a4d3e] text-white px-6 py-3.5 rounded-xl font-semibold hover:shadow-lg transition-all cursor-pointer flex items-center justify-center gap-2 hover:scale-105">
                                        <FaCalendarAlt />
