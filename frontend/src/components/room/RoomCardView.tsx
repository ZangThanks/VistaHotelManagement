    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      {rooms.map((room, index) => (
        <motion.div
          ...
          whileHover={{ y: -5 }}
          className="bg-white rounded-xl shadow-sm border border-[#ebe3d7] overflow-hidden group"
        >
          {/* Image */}
          <div className="relative h-48 bg-gradient-to-br from-[#ccbda3] to-[#ebe3d7] overflow-hidden">
            {room.image ? (
              <img
                src={room.image}
                alt={room.roomNumber}
            ...
            <div className="absolute top-3 right-3">
              <span
                ...
                } ${statusConfig[room.status].textColor} backdrop-blur-sm`}
              >
          ...
          <div className="p-5">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex items-center justify-between text-sm text-gray-600">
                ...
                <span className="font-medium">{room.capacity} guest</span>
              </div>
              <div className="flex items-center justify-between text-sm text-gray-600">
                <span>Floor</span>
