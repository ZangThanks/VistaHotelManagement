...
interface HolidayVoucherModalProps {
    ...
    vouchers: Voucher[];
    onSave: (
        selectedHolidays: { holiday: Holiday; voucherId: string }[],
    ) => void;
}
...
export default function HolidayVoucherModal({
    ...
    const handleSave = async () => {
        if (selectedHolidays.size === 0) {
            toast.error('Vui lòng chọn ít nhất một ngày lễ!', {
                duration: 3000,
            });
            return;
        }
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    Chọn ngày lễ và voucher tương ứng để tự động
                                    phân phối
                                </p>
                            </div>
                        </div>
