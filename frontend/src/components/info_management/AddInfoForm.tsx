// src/components/AddInfoForm.tsx
...
const AddInfoForm: React.FC<AddInfoFormProps> = ({ onClose }) => {
  ...
  const handleInputChange = (
    ...
    if (name === "shortDescription") {
      setCharCount((prev) => ({ ...prev, shortDescription: value.length }));
    } else if (name === "metaDescription") {
      setCharCount((prev) => ({ ...prev, metaDescription: value.length }));
    }
  };
    ...
    <DialogContent className="max-w-5xl">
      ...
      {success ? (
        <div className="p-6 bg-green-50 text-green-600 rounded-lg text-center">
          ...
          <p>
            Your new information has been added and will be available shortly.
          </p>
        </div>
      ) : (
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-4 pb-6 border-b border-cream">
            <h3 className="text-lg font-playfair font-semibold">Content</h3>
            <div>
              <label
            ...
            <div>
              ...
              <TinyMCE initialValue="" onChange={handleContentChange} />
            </div>
          </div>
          ...
          <div className="space-y-4 pb-6 border-b border-cream">
            ...
            <div>
              ...
              >
                ...
                <p className="mb-1">
                  Drag & drop featured image here or click to browse
                </p>
