    ...
    const handleAmountTenderedChange = (
        ...
        try {
            ...
            const due = parseFloat(
                paymentData.balanceDue.replace(/[^0-9.-]+/g, ''),
            );
            ...
            <div className="max-h-[70vh] overflow-y-auto px-6">
                ...
                <div className="mb-8">
                    <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
                        <i className="fas fa-file-invoice-dollar"></i> Bill
                        Summary
                    </h3>
                            ...
                            <div className="flex flex-col md:flex-row gap-6">
                                ...
                                <div>
                                    ...
                                    <ol className="space-y-2 mb-4">
                                        ...
                                        <li>
                                            4. Payment will be automatically
                                            confirmed
                                        </li>
                                    </ol>
                ...
                <div className="mb-6">
                    <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
                        <i className="fas fa-clipboard-check"></i> Check-out
                        Checklist
                    </h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <label htmlFor="roomKeys">
                                Room key cards returned
                            </label>
                        </div>
                        <div className="flex items-center gap-2">
                            <input
                        ...
                        <div className="flex items-center gap-2">
                            <input
                                ...
                                className="w-5 h-5 rounded"
                            />
                            <label htmlFor="feedbackRequested">
                                Feedback requested
                            </label>
                        </div>
                    </div>
