...
const PromotionTypeManagement: React.FC = () => {
    ...
    const handleAddPromotionType = async (
        ...
        try {
            ...
            toast.success('Promotion type created successfully!', {
                duration: 3000,
            });
    ...
    const handleEditPromotionType = async (
        ...
        try {
            ...
            toast.success('Promotion type updated successfully!', {
                duration: 3000,
            });
    ...
    const confirmDeletePromotionType = async () => {
        ...
        try {
            ...
            toast.success('Promotion type deleted successfully!', {
                duration: 3000,
            });
        ...
        <div className="min-h-screen bg-[#f5f0eb] p-6">
            <div className="max-w-[1600px] mx-auto space-y-4">
                ...
                <AddPromotionTypeModal
                    ...
                    onSubmit={
                        editPromotionType
                            ? handleEditPromotionType
                            : handleAddPromotionType
                    }
