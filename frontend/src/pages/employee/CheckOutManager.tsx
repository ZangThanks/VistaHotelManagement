...
export default function CheckOutManager() {
    ...
    try {
      ...
      switch (activeTab) {
        ...
        case "tomorrow": {
          ...
          data = await bookingService.getBookingsByCheckOutDate(tomorrowStr);
          data = data.filter((b) => b.status === "CHECKED_IN");
          break;
        }
        case "late": {
          ...
          data = data.filter((b) => {
            ...
            return b.status === "CHECKED_IN" && checkoutDate < currentDate;
          });
          break;
        }
        case "completed": {
  ...
  const handleConfirmPayment = async (
    ...
    console.log("CheckOutManager received:", {
      paymentMethod,
      amountTendered,
      changeAmount,
      notes,
          ...
          <div className="mt-5">
            ...
            {loading ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 mt-2">Loading checkout data...</p>
              </div>
            ) : (
              <CheckoutTable
                data={filteredData}
