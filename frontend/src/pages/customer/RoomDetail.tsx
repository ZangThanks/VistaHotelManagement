    ...
    fetch(`/room/${id}`)
      ...
      .catch(() => {
        ...
        const mock: Room = {
          ...
          notes:
            "This suite includes complimentary breakfast, access to the private beach and chauffeur service.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <main className="lg:col-span-2">
            ...
            <div className="mt-6 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
              <div>
                ...
                <div className="mt-3 flex gap-3 text-sm text-gray-700">
                  <div>{room.roomType?.maxOccupancy ?? 2} guests</div>
                  <div>·</div>
                  <div>{room.roomNumber ? `No. ${room.roomNumber}` : ""}</div>
                </div>
              </div>
            ...
            <section className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-3">Suite details</h3>
                <dl className="text-sm text-gray-700 space-y-2">
                  <div>
                    <dt className="font-medium">Occupancy</dt>
                    <dd>{room.roomType?.maxOccupancy ?? "—"} persons</dd>
                  </div>
                  <div>
                    <dt className="font-medium">Price</dt>
                    <dd>{formatCurrency(price)} / night</dd>
                  </div>
                  <div>
            ...
            <section className="mt-8">
              <h3 className="text-lg font-semibold mb-3">About this suite</h3>
                  ...
                  room={
                    {
                      roomNumber: "201",
                      roomType: {
                        typeName: "Two Bedroom Suite",
                        basePrice: 25000000,
                        description: "Spacious two-bedroom suite.",
                      } as any,
                      images: ["/images/mock-suite-2.jpg"],
                    } as any
                  }
                />
                <RoomCard
                  room={
                    {
                      ...
                      roomType: {
                        ...
                        basePrice: 12000000,
                        description: "Comfortable deluxe.",
                      } as any,
                      images: ["/images/mock-suite-3.jpg"],
                    } as any
                  }
                />
              </div>
            ...
            <div className="sticky top-24 bg-white border rounded-xl p-5 shadow">
              ...
              <div className="mt-4">
                ...
                <div className="mt-3 text-xs text-gray-600">
                  Selected: {checkIn ? checkIn.toLocaleDateString() : "-"} —{" "}
                  {/* {checkOut
                                        ? checkOut.toLocaleDateString()
                                        : '-'} */}
                </div>
              ...
              <div className="mt-4 text-xs text-gray-500">
                Free cancellation up to 48 hours before check-in. Rates and
