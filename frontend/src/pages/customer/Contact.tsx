    ...
    <div className="bg-gray-50">
      ...
      <div className="pt-20 mb-8 bg-gradient-to-r from-[#CCBDA3] to-[#EBE3D7]">
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="text-gray-700">
            Hotel Client Service Center is available from Monday to Sunday 24/7
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <p className="text-center text-sm py-8 text-gray-500">
          ...
          For support regarding services, please fill out the form below.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white rounded-lg shadow-sm p-8">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm mt-3">
              Our Client Advisors would be delighted to assist you. <br />
            ...
            <div className="mt-5">
              <div className="flex py-2">
                ...
                <p className="ml-2 text-sm text-gray-500">(00) 399 778 8390</p>
              </div>

              <div className="flex py-2">
                <i className="fa-solid fa-location-dot mt-1"></i>
                <p className="ml-3 text-sm text-gray-500">
                  365 Nguyen Van Bao Street, Go Vap District, HCM
                </p>
              </div>
            ...
            <p className="mt-10 text-sm text-gray-500 text-justify">
              By clicking "Send", you confirm that you have read the Privacy
              Statement and agree to Vélvere's processing of your personal data.
            </p>
          </div>
        </div>
      </div>
