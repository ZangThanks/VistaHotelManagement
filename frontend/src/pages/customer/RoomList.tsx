...
export default function RoomList() {
  ...
  const filteredRooms = rooms.filter((r) => {
    ...
    if (guests && r.roomType?.maxOccupancy && guests > r.roomType.maxOccupancy)
      return false;
  ...
  const handleRemoveFromCompare = (roomNumber: string) => {
    setCompareRooms((prev) => prev.filter((r) => r.roomNumber !== roomNumber));
  };
      ...
      >
        ...
        <div className="max-w-2xl text-center flex flex-col mx-auto pt-28 pb-8 px-4">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Our palatial suites extend over two exquisitely detailed floors,
            connected by grand staircases. Inspiring and intimate in equal
            measure.
          </p>
        </div>
                    ...
                    <section>
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          aria-expanded={openSections.accommodation}
                    ...
                    <section>
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          aria-expanded={openSections.checkIn}
                          className={`p-1 rounded-md transform transition-transform duration-200 ${
                    ...
                    <section>
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          aria-expanded={openSections.checkOut}
                          className={`p-1 rounded-md transform transition-transform duration-200 ${
                            openSections.checkOut ? "rotate-180" : ""
                          }`}
                        >
                          <svg
                            className="w-4 h-4 text-gray-600"
                    ...
                    <section>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <button
                          ...
                          aria-expanded={openSections.guests}
                          className={`p-1 rounded-md transform transition-transform duration-200 ${
                            openSections.guests ? "rotate-180" : ""
                          }`}
                        >
                          <svg
                            className="w-4 h-4 text-gray-600"
                    ...
                    <section>
                      ...
                      >
                        <div className="flex gap-2">
                          <input
                            type="number"
                            placeholder={`Min ${computedPriceRange.min || 0}`}
                            value={minPrice}
                            onChange={(e) =>
                              setMinPrice(
                                e.target.value === ""
                          ...
                          <input
                            type="number"
                            placeholder={`Max ${computedPriceRange.max || 0}`}
                            value={maxPrice}
                            onChange={(e) =>
                              setMaxPrice(
                                e.target.value === ""
          ...
          <main className="col-span-12 lg:col-span-8 xl:col-span-9">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  {displayedRooms.length} options · curated for comfort
                </p>
              </div>
            ...
            {!loading && !error && displayedRooms.length === 0 && (
              <div className="rounded-xl border border-dashed border-gray-300 p-12 text-center text-gray-600">
                ...
                <p className="text-lg font-medium">Không có phòng phù hợp</p>
                <p className="text-sm text-gray-500 mt-1">
